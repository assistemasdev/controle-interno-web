...
const EditOrganizationContactPage = () => {
    const navigate = useNavigate();
    const { applicationId, organizationId, contactId } = useParams();
    ...
    useEffect(() => {
        const fetchContact = async () => {
            try {
                const response = await OrganizationService.showOrganizationContact(organizationId, contactId, navigate);
        ...
        fetchContact();
    }, [organizationId, contactId, navigate]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await OrganizationService.updateOrganizationContact(organizationId, contactId, formData, navigate);
