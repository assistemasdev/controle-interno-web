...
const EditSupplierLocationPage = () => {
    ...
    useEffect(() => {
        const fetchLocationData = async () => {
            try {
                const response = await SupplierService.showSupplierLocation(
                    id,
                    addressId,
                    locationId
                );
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await SupplierService.updateSupplierLocation(
                id,
                addressId,
                locationId,
                formData,
...
export default EditSupplierLocationPage;
