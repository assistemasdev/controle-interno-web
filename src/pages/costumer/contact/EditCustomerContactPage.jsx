...
const EditCustomerContactPage = () => {
    ...
    useEffect(() => {
        const fetchContact = async () => {
            try {
                const response = await CustomerService.showCustomerContact(id, contactId, navigate);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await CustomerService.updateCustomerContact(id, contactId, formData, navigate);
