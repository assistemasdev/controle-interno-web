...
const EditCustomerAddressPage = () => {
    ...
    const fetchAddress = async () => {
        try {
            ...
            setMessage({ type: 'error', text: error.message || 'Erro ao buscar pelo endereço' });
            console.error(error);
        } finally {
            setLoading(false);
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await CustomerService.updateCustomerAddress(id, addressId, sanitizedData, navigate);
